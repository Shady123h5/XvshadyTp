...
local Window = Luna:CreateWindow({Name = "Steal a Brainrot | H4x Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "LunaConfig"})
...
local Section = Tab2:CreateSection({
	Name = "Steal Helper"
})
...
local Section = Tab3:CreateSection({
...
local Section = Tab4:CreateSection({
	Name = "ESP Toggles"
})
...
local Section = Tab5:CreateSection({
...
Tab6:CreateButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({ Name = "Devil Ugly's Scripts", Content = "DC link has been successfully copied!", Duration = 2 })
    end
})
...
local Section = Tab7:CreateSection({
...
-- Initialize Luna (safe calls)
pcall(function() Luna:Init() end)
