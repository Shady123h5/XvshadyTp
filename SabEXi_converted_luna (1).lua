...
local Window = Luna:CreateWindow({Name = "Steal a Brainrot | H4x Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
local selectedPets = {}
local SelectBrainrot = Tab2:CreateDropdown({Name = "Select Brainrot",
    CurrentOption = {},
    Options = allPets,
...
Tab2:CreateToggle({Name="StealToggle", CurrentValue =false, Callback=function(v) _G.AutoStealEnabled = v end})
Tab2:CreateToggle({Name="StealAllToggle", CurrentValue =false, Callback=function(v) _G.AutoStealAllEnabled = v end})
Tab2:CreateToggle({Name="KickToggle", CurrentValue =false, Callback=function(v) kickEnabled=v promptTriggered=false end})
...
local SelectBrainrot = Tab3:CreateDropdown({Name = "Select Brainrot",
    CurrentOption = {},
    Options = allPets,
    MultipleOptions = true,
    Callback = function(values)
...
Tab3:CreateDropdown({Name = "Select Collect Method",
    CurrentOption = "Tween",
    Options = {"Tween", "Walk"},
    Callback = function(v)
        selectedFarmMode = v
...
local SelectBrainrot = Tab5:CreateDropdown({Name = "Select Brainrot",
    Options = allPets,
    MultipleOptions = true,
    CurrentOption = {},
    Callback = function(values)
