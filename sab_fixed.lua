...
local OrionLib; do
    local ok, lib = pcall(function()
        return loadstring((function() local ok, result = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/iubauhqhuiauhiszivjou1i89781iuwnuk8p/-/refs/heads/main/Lib.lua") end);if ok then return result else warn("HttpGet failed") return "" end end)())()
    end)
