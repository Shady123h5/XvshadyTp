...
local Window = Luna:CreateWindow({Name = "Steal a Brainrot | H4x Hub", ConfigSettings = {ConfigFolder = "OrionTest"}})
...
local selectedPets = {}
local SelectBrainrot = Tab2:CreateDropdown({
...
local SelectBrainrot = Tab3:CreateDropdown({
    Name = "Select Brainrot",
    CurrentValue = {},
    Options = allPets,
    Multi = true,
...
local SelectBrainrot = Tab5:CreateDropdown({
    Name = "Select Brainrot",
    Options = allPets,
    Multi = true,
    CurrentValue = {},
...
-- Load saved configuration for Luna
